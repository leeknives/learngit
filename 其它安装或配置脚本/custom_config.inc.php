...
/* [SMTP] */
$g_smtp_host        = '192.168.10.254';  #SMTP server MUST BE configured

$g_tl_admin_email     = 'mantisbt@yunchuangyi.cn'; # for problem/error notification
$g_from_email         = 'mantisbt@yunchuangyi.cn'; # email sender
$g_return_path_email  = 'mantisbt@yunchuangyi.cn';
...
/** Configure only if SMTP server requires authentication */
$g_smtp_username    = 'mantisbt';  # user
$g_smtp_password    = '000000';  # password
